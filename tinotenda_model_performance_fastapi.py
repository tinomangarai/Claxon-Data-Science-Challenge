    ...
    <html>
        ...
        <body>
            ...
            <form action="/predict" method="post">
                ...
                <label for="actual_outcome">Actual Outcome (0 or 1):</label>
                <input type="text" id="actual_outcome" name="actual_outcome" placeholder="0 or 1"><br><br>
...
# Function to log predictions and actual outcomes
def log_prediction(prediction, actual_outcome):
    with open('prediction_log.txt', 'a') as log_file:
        log_file.write(f"Prediction: {prediction}, Actual Outcome: {actual_outcome}\n")

# Function to analyze poor predictions
def analyze_poor_performance(data, prediction, actual_outcome):
    if prediction != actual_outcome:
        return "Model performed poorly for this instance."
    return "Model performed well for this instance"
...
async def predict(
    ...
    try:
        ...
        age = int(age)
        salary = float(salary)
        actual_outcome = int(actual_outcome)  # Assuming actual_outcome is numeric (0 or 1)
        ...
        log_prediction(result, actual_outcome)

        # Analyze poor performance
        poor_performance_message = analyze_poor_performance(processed_data, prediction[0], actual_outcome)
        ...
        <html>
            ...
            <body>
                ...
                <div style="border:1px solid black; padding:10px; margin-bottom:10px;">
                    <strong>Poor Performance Analysis:</strong><br> {poor_performance_message}
                </div>
                <br><br>
